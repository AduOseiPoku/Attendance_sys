...
urlpatterns = [
    ...
    path('owner/academic-levels/promote/',                 views.owner_promote_students,    name='owner_promote_students'),
    path('owner/academic-levels/delete/<int:year_id>/',    views.owner_delete_academic_level, name='owner_delete_academic_level'),
    path('owner/alumni/',                                  views.owner_alumni_list,         name='owner_alumni_list'),
